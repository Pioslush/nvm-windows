...
TMPDIR="${TMPDIR:-/tmp}"
CLUSTER="$(mktemp -d "$TMPDIR/gameday-pg.XXXXXX")"
...
export DATABASE_URL="postgresql://postgres@127.0.0.1:$PORT/gameday_test"
psql "postgresql://postgres@127.0.0.1:$PORT/postgres" -q -c "create database gameday_test"
