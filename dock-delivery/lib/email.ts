...
const FROM = process.env.EMAIL_FROM ?? "Dock Delivery <onboarding@resend.dev>";
...
<html><body style="margin:0;padding:0;background:#f4f4f5;font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:24px 16px;">
    <div style="font-size:14px;font-weight:700;letter-spacing:.08em;color:#334155;text-transform:uppercase;padding:8px 4px;">Dock Delivery</div>
    ...
    <div style="font-size:12px;color:#71717a;padding:12px 4px;">Sent by Dock Delivery — dock &amp; delivery scheduling.</div>
  </div>
</body></html>`;
}
